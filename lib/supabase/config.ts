...
//
// Untuk memakai project Supabase Anda sendiri, cukup isi environment variable
// NEXT_PUBLIC_SUPABASE_URL dan NEXT_PUBLIC_SUPABASE_ANON_KEY — nilainya akan
// menimpa cadangan ini.
